...
namespace ATMManager
{
    ...
    [ToolboxItem(true)]
    public class ButtonColorSet : System.Windows.Forms.Button
    {
        /// <summary>
        /// 获得当前进程，以便重绘控件
        /// </summary>
        ...
        /// 边框颜色
        /// </summary>
        private Color _BorderColor = Color.Blue;//Color.FromArgb(0xA7, 0xA6, 0xAA);
       ...
       //// }
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == 0xf || m.Msg == 0x133)
            {
              ...
              //  if (this.FlatStyle == FlatStyle.Flat||this.FlatStyle==FlatStyle.Standard)
              //  {
                    //////边框Width为1个像素
                   System.Drawing.Pen pen = new Pen(this.BackColor, 1);
                  ...
                  //  System.Drawing.Graphics g = Graphics.FromHdc(hDC);
                   ...
                   BufferedGraphics myBuffer = currentContext.Allocate(hDC, this.DisplayRectangle);
